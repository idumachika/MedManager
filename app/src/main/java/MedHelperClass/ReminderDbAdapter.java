...
public class ReminderDbAdapter {
    ...
    public static final String KEY_MEDICATION_NAME = "name";
    ...
    private static final String DATABASE_CREATE =
            "create table " + DATABASE_TABLE + " ("
                    ...
                    + KEY_MEDICATION_NAME + " text not null, "
     ...
     *
     * @param name the title of the reminder
     * @param interval the body of the reminder
     * @param reminderDateTime the date and time the reminder should remind the user
     * @return rowId or -1 if failed
     */
    public long createReminder(String name, String interval, String reminderDateTime) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_MEDICATION_NAME, name);
        initialValues.put(KEY_INTERVAL, interval);
        initialValues.put(KEY_DATE_TIME, reminderDateTime);
        Log.i("chika","Name "+ reminderDateTime);
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_MEDICATION_NAME,
                KEY_INTERVAL, KEY_DATE_TIME}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                                KEY_MEDICATION_NAME, KEY_INTERVAL, KEY_DATE_TIME}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        Log.i("chika","Name "+ KEY_MEDICATION_NAME);
        if (mCursor !=null){
     ...
     * @param name value to set reminder title to
     * @param interval value to set reminder body to
     ...
     */
    public boolean updateReminder(long rowId, String name, String interval, String reminderDateTime) {
        ContentValues args = new ContentValues();
        args.put(KEY_MEDICATION_NAME, name);
